...
os.chdir("<project root directory>")
...
img_train = np.array([rgb2gray(np.array(Image.open('<rico root directory>/combined/{}.jpg'.format(photo_path)).resize((360, 640)))) for photo_path in X_train])
